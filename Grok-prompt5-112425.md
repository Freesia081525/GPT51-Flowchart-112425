Hi please improve the design by improving the usability, adding status indicators and wow dashboard. Please also create new WOW NEAT ui that user can select light/dark themes, english/traditional chinese, 20 styles based on flowers. Sample design:import streamlit as st
import yaml
import os
